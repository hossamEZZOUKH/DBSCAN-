...
public class main_interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Run Algorithm");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       //Run fonction
         ...
         minPts = Integer.parseInt(jTextField4.getText());
         eps= Double.parseDouble(jTextField3.getText());
         separateur=jTextField5.getText();
         
		List<Cluster> clusters = null;
        try {
            clusters = algo.runAlgorithm(inputFile, minPts, eps,separateur);
		...
		jTextArea1.append(algo.printStatistics());
		
		// Print the clusters found by the algorithm
		// For each cluster:
		int i=0;
		for(Cluster cluster : clusters) {
			jTextArea1.append("Cluster " + i++ + "\n");
			// For each data point:
			for(DoubleArray dataPoint : cluster.getVectors()) {
				jTextArea1.append("   " + dataPoint + "\n");
			}
		}
               
                
                //System.out.println(inputFile+ "\n" + eps + "\n" + minPts );
                //jTextArea1.append(inputFile + "\n" + outputFile + "\n"+ minPts + "\n" + eps);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        outputFile = jTextField2.getText().replace("\\", "\\\\");
        
        try {
            //fonction qui designe le plot 
            MainTestClusterViewerFile.ClusterViewer(outputFile);
        } catch (IOException ex) {
            Logger.getLogger(main_interface.class.getName()).log(Level.SEVERE, null, ex);
        }
