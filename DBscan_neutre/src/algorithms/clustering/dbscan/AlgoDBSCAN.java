...
//		System.out.println(kdtree.toString());
	...
	public String printStatistics() {
                String Stat="";
		Stat=Stat +"========== DBSCAN - STATS ============\n";
		Stat=Stat +" Total time ~: " + (endTimestamp - startTimestamp)
				+ " ms \n";
		Stat=Stat + " Max memory:" + MemoryLogger.getInstance().getMaxMemory() + " mb \n";
		Stat=Stat + " SSE (somme des carrés des erreurs) (lower is better) : " + ClustersEvaluation.getSSE(clusters, distanceFunction)+"\n";
		Stat=Stat + " Number of noise points: " + numberOfNoisePoints +"\n";
		Stat=Stat + " Number of clusters: " + clusters.size()+"\n";
		Stat=Stat +"=====================================\n";
                return Stat;
	}
