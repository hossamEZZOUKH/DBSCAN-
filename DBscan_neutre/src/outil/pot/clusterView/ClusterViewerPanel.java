...
import outil.pot.clusterView.PreferencesManager;
import outil.pot.clusterView.Plot;
import outil.pot.clusterView.Plot.Data;
import outil.pot.clusterView.Plot.LegendFormat;
import outil.pot.clusterView.Plot.Line;
import outil.pot.clusterView.Plot.Marker;
	...
	protected void export() {
		...
		try {
		    ...
		    if (previousPath == null) {
		       URL main = null ;//MainTestApriori_saveToFile.class.getResource("MainTestApriori_saveToFile.class");
