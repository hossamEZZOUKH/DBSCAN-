...
//		panelTools.setBounds(0, 0, 800, 100);
		...
		buttonSaveAsPng.setIcon(new ImageIcon(ClusterViewer.class.getResource("/gui/icons/zoomin.gif")));
		...
		buttonPrint.setIcon(new ImageIcon(ClusterViewer.class.getResource("/gui/icons/zoomin.gif")));
